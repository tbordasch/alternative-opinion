...
export default function Navbar() {
  ...
  return (
    <nav className="w-full border-b border-[#5C3A21]/20 dark:border-white/10 bg-white dark:bg-[#1a2332] transition-colors duration-200">
      <div className="relative flex items-center justify-between py-4 sm:py-5 md:py-6">
        {/* Left: Navigation Elements - At the very edge */}
        <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 pl-3 sm:pl-6 md:pl-8 lg:pl-10 xl:pl-16">
          <Link 
            href="/about" 
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 flex-shrink-0 px-2">
          <Link href="/" className="group text-center">
            <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-[#5C3A21] dark:text-white mb-0.5 sm:mb-1 transition-colors group-hover:text-[#8B4513] dark:group-hover:text-[#5B9BD5]">
              The Opinions
            </h1>
            <p className="text-[10px] sm:text-xs md:text-sm text-[#5C3A21]/70 dark:text-white/70 font-light hidden sm:block">
        ...
        <div className="flex items-center gap-2 sm:gap-3 md:gap-4 pr-3 sm:pr-6 md:pr-8 lg:pr-10 xl:pr-16">
          {/* Rotation Info */}
